...
function MapSection(params) {
  ...
  this.pointCloudPosition = new THREE.Vector3();
  this.pointCloudPosition.clone(this.pointCloud.position);
}
...
MapSection.prototype.updateGroundPlaneOffset = function(offset) {
  this.pointCloud.position.y = this.pointCloudPosition.y;
  this.pointCloud.position.y = this.pointCloud.position.y + offset;
}
