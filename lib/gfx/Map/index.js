...
function Map(params) {
  ...
  earthLabel.position.x = 64;
  earthLabel.position.z = 64;
  earthLabel.position.y = 0;
  scene.add(earthLabel);

  var loader = new THREE.GLTFLoader();

  loader.load( 'assets/images/' + 'scene-processed' + '.glb', function ( gltf ) {
  
    gltf.scene.position.x = 64;
