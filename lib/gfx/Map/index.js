...
Map.prototype.getCameraRotation = function (targetPosition) {
  const rotateX = Math.atan2(this.cameraPosition.x - targetPosition.x, this.cameraPosition.z - targetPosition.z);
  const rotateY = Math.atan2(targetPosition.y - this.cameraFootstoolPosition.y , targetPosition.z - this.cameraFootstoolPosition.z ) + Math.PI / 2;
  return {
    x: rotateX,
    y: rotateY,
  }; 
